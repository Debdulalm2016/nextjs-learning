// create-form.tsx for invoice creation form
'use client';
...
export default function Form({ customers }: { customers: CustomerField[] }) {
  ...
  console.log('Form state:', state); //for debugging purposes
  return (
    <form action={formAction} className="space-y-6">
      ...
      <div className={styles.form_message} aria-live="polite" aria-atomic="true">
          {state.message &&                
